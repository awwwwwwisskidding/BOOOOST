			...
			Embeds: &[]*discordgo.MessageEmbed{
				{
					...
					Footer: &discordgo.MessageEmbedFooter{
						Text:    "Powered by .gg/",
						IconURL: "https://media.discordapp.net/attachments/1220370444880711680/1239561206948167690/image.png?ex=66435ed5&is=66420d55&hm=4782c0cdd01b68fe0840fba0f75f16052a6cf5e9a0f9a67cfe12f01206af48e5&=&format=webp&quality=lossless",
					},
				},
			},
		})
...
func PaypalCommand(s *discordgo.Session, i *discordgo.InteractionCreate) {
	...
	if err != nil {
		fmt.Println("Error responding to /ltc command:", err)
	}
}
